...
<form action="" method="POST">
    ...
    <section class="container mt-4">
        ...
        <div class="form-outline mb-3">
            <textarea class="form-control" id="textAreaExample" rows="4" name="tanggapan"></textarea>
        ...
        <button class="btn btn-success mt-3" type="submit" name="submit">Tanggapi</button>
...
<script>
    function redirectToDetailLaporan() {
        window.location.href = '/tanggapanPetugas';
    }
</script>